...
public class NtlinkMessageParser {
  ...
  public String createCancelRequest(NtlinkCancelRequestModel requestModel)
    ...
    try {
      ...
      element
          .addChildElement(NtlinkModernaRequest.USER, NtlinkModernaRequest.ISER)
          .addTextNode(requestModel.getUser());
      element
          .addChildElement(NtlinkModernaRequest.PASS, NtlinkModernaRequest.ISER)
      ...
      if(requestModel.getFolioSustituto()!=null) {
        element
                .addChildElement(NtlinkModernaRequest.FOLIO_SUSTITUTO, NtlinkModernaRequest.ISER)
                .addTextNode(requestModel.getFolioSustituto());
      }
      element
      ...
      element
          .addChildElement(NtlinkModernaRequest.EXPRESION, NtlinkModernaRequest.ISER)
          .addTextNode(requestModel.getExpresion());
      element
          .addChildElement(NtlinkModernaRequest.RFC_RECEPTOR, NtlinkModernaRequest.ISER)
  ...
  public String createStampRequest(NtlinkRequestModel requestModel) throws NtlinkClientException {
    try {
      ...
      element
          ...
          .addTextNode(requestModel.getUserPass());
      element
          .addChildElement(NtlinkModernaRequest.COMPROBANTE, NtlinkModernaRequest.ISER)
  ...
  private SOAPBodyElement createStampHeaders(SOAPMessage soapMessage, String requestType)
    ...
    envelope.addNamespaceDeclaration(
        NtlinkModernaRequest.SOAP_ENV, NtlinkModernaRequest.SOAP_ENV_URL);
  ...
  public NtlinkResponseModel getErrorResponse(String errorResponse) throws NtlinkClientException {
    try {
      ...
      e.printStackTrace();
      throw new NtlinkClientException(
          new NtlinkErrorMessage("Error parsing Error Response", e.getMessage()),
          HttpStatus.SC_CONFLICT);
    }
  }
  ...
  public <T> T getResponse(String stringResponse, Class<T> clazz) throws NtlinkClientException {
    try {
      ...
      stringResponse =
          stringResponse.replace("xmlns=\"https://ntlink.com.mx/IServicioTimbrado\"", "");
      stringResponse =
          stringResponse.replace("xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"", "");
      stringResponse =
          stringResponse.replace(
              "xmlns:a=\"http://schemas.datacontract.org/2004/07/CertificadorWs\"", "");
      stringResponse = stringResponse.replace("i:nil=\"false\"", "");
      ...
      e.printStackTrace();
      throw new NtlinkClientException(
          new NtlinkErrorMessage("Error parsing Response", e.getMessage()), HttpStatus.SC_CONFLICT);
    }
  }

  public <T> T getResponseCancel(String stringResponse, Class<T> clazz)
      throws NtlinkClientException {
    try {
      stringResponse = stringResponse.replace("a:", "");
      stringResponse = stringResponse.replace("i:nil=\"true\"", "");
