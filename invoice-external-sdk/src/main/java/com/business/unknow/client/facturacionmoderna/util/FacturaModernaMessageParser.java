...
public class FacturaModernaMessageParser {
  ...
  public String createCancelRequest(FacturaModernaRequestModel requestModel)
    ...
    try {
      ...
      SOAPElement element =
          createStampHeaders(soapMessage, FacturacionModernaRequest.REQUEST_CANCELADO);
      SOAPElement element2 =
          element
              .addChildElement(FacturacionModernaRequest.REQUEST)
              .addAttribute(
                  soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
                  FacturacionModernaRequest.SOAP_ENV_STRUCT);
      element2
          .addChildElement(FacturacionModernaRequest.USER_PASS_PARAMETER)
          .addAttribute(
              soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
              FacturacionModernaRequest.STRING_TYPE_PARAMETER)
          .addTextNode(requestModel.getUserPass());
      element2
          .addChildElement(FacturacionModernaRequest.USER_ID_PARAMETER)
          .addAttribute(
              soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
              FacturacionModernaRequest.STRING_TYPE_PARAMETER)
          .addTextNode(requestModel.getUser());
      element2
          .addChildElement(FacturacionModernaRequest.EMISOR_PARAMETER)
          .addAttribute(
              soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
              FacturacionModernaRequest.STRING_TYPE_PARAMETER)
          .addTextNode(requestModel.getRfc());
      element2
          .addChildElement(FacturacionModernaRequest.UUID_PARAMETER)
          .addAttribute(
              soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
              FacturacionModernaRequest.STRING_TYPE_PARAMETER)
      ...
      throw new FacturaModernaClientException(
          new FacturaModernaErrorMessage(
              "Error creating Factura moderna Stamp Message", e.getMessage()),
          HttpStatus.SC_CONFLICT);
    }
  }

  public String createStampRequest(FacturaModernaRequestModel requestModel)
      throws FacturaModernaClientException {
    try {
      MessageFactory messageFactory = MessageFactory.newInstance();
      SOAPMessage soapMessage = messageFactory.createMessage();
      SOAPFactory soapFactory = SOAPFactory.newInstance();
      SOAPElement element =
          createStampHeaders(soapMessage, FacturacionModernaRequest.REQUEST_TIMBRADO);
      SOAPElement element2 =
          element
              .addChildElement(FacturacionModernaRequest.REQUEST)
              .addAttribute(
      ...
      element2
          ...
          .addTextNode(requestModel.getRfc());
      element2
          .addChildElement(FacturacionModernaRequest.TEXT_PARAMETER)
          .addAttribute(
              soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
              FacturacionModernaRequest.STRING_TYPE_PARAMETER)
          .addTextNode(requestModel.getXml());
      element2
          .addChildElement(FacturacionModernaRequest.GENERAR_TEXT_PARAMETER)
          .addAttribute(
              soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
              FacturacionModernaRequest.BOOLEAN_TYPE_PARAMETER)
          .addTextNode(requestModel.isGenerarTxt().toString());
      element2
          .addChildElement(FacturacionModernaRequest.GENERAR_PDF_PARAMETER)
          .addAttribute(
              soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
              FacturacionModernaRequest.STRING_TYPE_PARAMETER)
          .addTextNode(requestModel.isGenerarPdf().toString());
      element2
          .addChildElement(FacturacionModernaRequest.GENERAR_CBB_PARAMETER)
          .addAttribute(
              soapFactory.createName(FacturacionModernaRequest.TYPE_PARAMETER),
              FacturacionModernaRequest.BOOLEAN_TYPE_PARAMETER)
  ...
  private SOAPBodyElement createStampHeaders(SOAPMessage soapMessage, String requestType)
      throws SOAPException {
    SOAPPart soapPart = soapMessage.getSOAPPart();
    SOAPEnvelope envelope = soapPart.getEnvelope();
    envelope.addNamespaceDeclaration(
        FacturacionModernaRequest.NS1, FacturacionModernaRequest.URL_TIMBRADO);
    envelope.addNamespaceDeclaration(
        FacturacionModernaRequest.XSD, FacturacionModernaRequest.URL_SCHEMA);
    envelope.addNamespaceDeclaration(
        FacturacionModernaRequest.XSI, FacturacionModernaRequest.URL_SCHEMA_INSTANCE);
    envelope.addNamespaceDeclaration(
        FacturacionModernaRequest.SOAP_ENV, FacturacionModernaRequest.URL_ENCODING);
    SOAPBody soapBody = envelope.getBody();
    return soapBody.addBodyElement(
        envelope.createName(requestType, FacturacionModernaRequest.NS1, ""));
  }

  public FacturaModernaErrorModel getErrorResponse(String errorResponse)
      throws FacturaModernaClientException {
    try {
  ...
  public <T> T getResponse(String stringResponse, Class<T> clazz)
      throws FacturaModernaClientException {
    try {
      ...
      throw new FacturaModernaClientException(
          new FacturaModernaErrorMessage("Error parsing Response", e.getMessage()),
          HttpStatus.SC_CONFLICT);
    }
  }
  ...
  protected FacturaModernaErrorModel unmarshallError(SOAPElement xml) throws JAXBException {
    ...
    FacturaModernaErrorModel obj =
        unmarshaller.unmarshal(xml, FacturaModernaErrorModel.class).getValue();
    return obj;
  }
