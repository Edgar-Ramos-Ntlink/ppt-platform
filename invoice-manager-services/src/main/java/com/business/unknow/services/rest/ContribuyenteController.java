...
public class ContribuyenteController {
  ...
  @Autowired private ContribuyenteService service;
  ...
  public ResponseEntity<Page<ContribuyenteDto>> getClientsByParameters(
    ...
    return new ResponseEntity<>(
        service.getContribuyentesByParametros(rfc, razonSocial, page, size), HttpStatus.OK);
  }
  ...
  @PostMapping
  public ResponseEntity<ContribuyenteDto> insertClient(
  ...
  @PutMapping("/{rfc}")
  public ResponseEntity<ContribuyenteDto> updateClient(
      @PathVariable String rfc, @RequestBody @Valid ContribuyenteDto contribuyente) {
