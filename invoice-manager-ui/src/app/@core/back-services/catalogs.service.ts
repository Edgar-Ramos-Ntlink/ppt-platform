  ...
  public getAllUsoCfdis(): Promise<any> {
    return new Promise((resolve) => {
      if (this.usoCfdi !== undefined) {
        ...
        this.httpClient.get("/api/catalogs/uso-cdfi").subscribe((cat) => {
          this.usoCfdi = cat;
          resolve(cat);
        });
      }
  ...
  public getAllRegimenFiscal(): Promise<any> {
    return new Promise((resolve) => {
      if (this.regimenFiscal !== undefined) {
        ...
        this.httpClient.get("/api/catalogs/regimen-fiscal").subscribe((cat) => {
  ...
  public getStatusPago(): Promise<any> {
    return new Promise((resolve) => {
      if (this.statusPago !== undefined) {
        ...
        this.httpClient.get("/api/catalogs/status-pago").subscribe((cat) => {
          this.statusPago = cat;
          resolve(cat);
        });
      }
  ...
  public getStatusValidacion(): Promise<any> {
    return new Promise((resolve) => {
      if (this.statusValidacion !== undefined) {
        ...
        this.httpClient.get("/api/catalogs/status-evento").subscribe((cat) => {
